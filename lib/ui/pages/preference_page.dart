...
class PreferancePage extends StatefulWidget {
  ...
  PreferancePage(this.registrationData);

  @override
  _PreferancePageState createState() => _PreferancePageState();
}

class _PreferancePageState extends State<PreferancePage> {
